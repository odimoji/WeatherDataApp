...
#ifndef UNTITLED7_ADVANCEDHISTORICALWEATHER_H
#define UNTITLED7_ADVANCEDHISTORICALWEATHER_H
...
class AdvancedHistoricalWeather {
private:
...
public:
    ...
    AdvancedHistoricalWeather AdvancedHistoricalWeatherDisplay();

    AdvancedHistoricalWeather FetchDataFromAPI(double, double);
...
#endif //UNTITLED7_ADVANCEDHISTORICALWEATHER_H
